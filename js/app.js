...
***************************************************************************** */
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (targetElement.classList.contains("search-form__icon")) document.querySelector(".search-form").classList.toggle("active"); else if (!targetElement.closest(".search-form")) document.querySelector(".search-form").classList.remove("active");
            ...
            if (targetElement.classList.contains("cart-header__icon") || targetElement.closest(".cart-header__icon")) {
                ...
                e.preventDefault();
            } else if (!targetElement.closest(".cart-header") && !targetElement.classList.contains("actions-product__button")) document.querySelector(".cart-header").classList.remove("active");
